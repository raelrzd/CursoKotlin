...
fun testaFuncionarios() {
    ...
    // impressão modelo.Gerente (teteu)
    println("modelo.Gerente: ${teteu.nome}")
    ...
    // impressão modelo.Diretor (Lopes)
    println()
    println("modelo.Diretor: ${lopes.nome}")
    ...
    // impressão modelo.Analista (Gui)
    println()
    println("modelo.Analista: ${gui.nome}")
    println("CPF: ${gui.cpf}")
    println("Salário: ${gui.salario}")
    println("Bonificação: ${gui.bonificacao()}")

    // impressão modelo.Auxiliar (Marcia)
    println()
    println("modelo.Auxiliar: ${marcia.nome}")
